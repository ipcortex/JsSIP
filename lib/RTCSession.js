  ...
  answer(options = {})
  {
    ...
    Promise.resolve()
      ...
      .then(() =>
      {
        ...
        const offer = new RTCSessionDescription({ type: 'offer', sdp: `${e.sdp}a=end-of-candidates\r\n` });
      ...
      switch (request.method)
      {
        case JsSIP_C.ACK:
          ...
          if (this._late_sdp)
          {
            ...
            const answer = new RTCSessionDescription({ type: 'answer', sdp: `${e.sdp}a=end-of-candidates\r\n` });
